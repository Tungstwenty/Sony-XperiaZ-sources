...
printOptions:
	...
	sBlk.flags = SQUASHFS_MKFLAGS(noI, noD, noF, noX, no_fragments,
		...
		no_xattrs, comp_opts);
        /*Using a fixed time instead get current time, this will avoid the 
	 * inconsistent squashfs image in different build*/
	sBlk.mkfs_time = 0x55045B00; /*2015-03-15 00:00:00 UTC+0*/
